...
cp data_preparation/configs/phenogenius-config.yaml configurations/phenogenius-1.1.1/2024-07-15/config.yaml
...
cp data_preparation/configs/svanna-config.yaml configurations/svanna-1.0.4/config.yaml
